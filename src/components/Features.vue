          ...
          >
            <div class="px-4 py-5 flex-auto">
              ...
              <TextEdit
                ...
                @input="value => setComponentProperty('feature2.description', value)"
              />
            </div>
          </div>
        </div>
          ...
          >
            <div class="px-4 py-5 flex-auto">
              ...
              <TextEdit
                ...
                @input="value => setComponentProperty('feature3.description', value)"
              />
            </div>
          </div>
        </div>
          ...
          >
            ...
            <blockquote class="relative p-8 mb-4">
              ...
              <TextEdit
                ...
                @input="value => setComponentProperty('work.imageDescription', value)"
              />
            </blockquote>
          </div>
        </div>
...
} from "../editor/pageStateUtils";
export default {
  methods: {
    getComponentProperty(path) {
      return getComponentProperty(this.$attrs, path);
    },
    setComponentProperty(path, value) {
      setComponentProperty(this.$attrs.id, path, value);
    }
  }
};
</script>
